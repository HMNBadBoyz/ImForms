...
namespace ImForms
{
    ...
    public partial class ImFormsMgr
    {
        ...
        public bool RadioButton(string text, bool booleancheck,  [CmplTime.CallerFilePath] string callerfilepath ="",[CmplTime.CallerLineNumber] int callerlinenumber= 0,[CmplTime.CallerMemberName] string callermembername = "")
        {
            var id = new IDType(callerfilepath,callerlinenumber,callermembername);
            bool FirstPass = !ControlExists(id);
            var ctrl = ProcureControl(id, x => InitControlForClicking(new WForms.RadioButton(), x));
        ...
        public bool BeginTree(string text,   [CmplTime.CallerFilePath] string callerfilepath ="",[CmplTime.CallerLineNumber] int callerlinenumber= 0,[CmplTime.CallerMemberName] string callermembername = "")
        {
            var id = new IDType(callerfilepath,callerlinenumber,callermembername);
            bool FirstPass = !ControlExists(id);
            var ctrl = ProcureControl(id, x => InitControlForClicking(new BufferedTreeView(), x));
